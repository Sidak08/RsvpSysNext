...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-row justify-between items-center w-full lg:mt-7 mt-2">
      ...
      <div className="absolute top-0 right-0 flex justify-end md:hidden mr-4">
        <button
          onClick={onClick}
          className={`${renderMobileMenu ? "hidden" : "fade-in"}`}
        >
          <div className={`w-[30px] h-[27px] top-[5px] right-0 relative`}>
        ...
        >
          <div className="absolute">
            <div className="w-[364px] h-[209.14px] relative">
              <div className="w-[30px] h-[30px] left-[334px] top-[10.14px] absolute">
              ...
              <div className="w-[364px] h-[47.23px] left-0 top-0 absolute">
                <div className="w-[219px] h-[47.23px] left-0 top-0 absolute">
                  <div className="w-[161px] h-[38px] left-[58px] top-[2.14px] absolute text-purple-700 text-[38px] font-normal font-['Inika']">
                    QuikSeat
                  </div>
                  <div className="w-[47px] h-[47.23px] left-0 top-0 absolute">
                    <div className="w-[10.91px] h-[10.91px] left-[-0px] top-[34.47px] absolute origin-top-left rotate-[-1.23deg] bg-indigo-900 rounded-full" />
                    <div className="w-[10.91px] h-[10.91px] left-[35.86px] top-[34.58px] absolute origin-top-left rotate-[-1.23deg] bg-purple-700 rounded-full" />
                    <div className="w-[33.13px] h-[11.52px] left-[4.91px] top-[28.40px] absolute origin-top-left rotate-[-59deg] bg-purple-700 rounded-[23px]" />
                    <div className="w-[29.47px] h-[11.52px] left-[15.54px] top-[41.30px] absolute origin-top-left rotate-[-59deg] bg-indigo-900 rounded-[23px]" />
              ...
              <div className="w-[353px] h-[149px] left-[11px] top-[60.14px] absolute bg-neutral-800/opacity-95 rounded-[14px] border-2 border-neutral-700" />
              <div className="w-[319px] h-0.5 left-[31px] top-[107.14px] absolute bg-neutral-700 rounded-sm" />
              <div className="w-[319px] h-0.5 left-[30px] top-[154.14px] absolute bg-neutral-700 rounded-sm" />
              <div className="left-[278px] top-[73.14px] absolute text-white text-[22px] font-normal font-['Inter']">
                Pricing
              </div>
              <div className="left-[267px] top-[163.14px] absolute text-white text-[22px] font-normal font-['Inter']">
                Contact
              </div>
              <div className="left-[237px] top-[118.14px] absolute text-white text-[22px] font-normal font-['Inter']">
                Dashboard
              </div>
            </div>
          </div>
